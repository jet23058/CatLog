...
**極簡貓資產** 是一個現代化、介面精美的個人資產與投資組合追蹤應用程式。專為重視數據分析的投資者設計，提供直觀的資產增長趨勢、月度收支管理，以及深度的個股績效分析。

> 📖 **詳細規劃請見**：[專案計劃書 (Project Plan)](PROJECT_PLAN.md)

![Version](https://img.shields.io/badge/version-2.8.1-teal.svg)
...
- **智慧匯入**: 
  ...
  - **差異預覽**: JSON 備份與花費 CSV 匯入前，會先顯示「新增 / 刪除 / 修改」差異明細。
